    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: IndexedStack(
          index: _index,
          children: const [
            _HomeTabBody(title: 'Home', subtitle: 'Welcome to PurePath'),
            _HomeTabBody(title: 'Insights', subtitle: 'Your daily habits'),
            _HomeTabBody(title: 'Community', subtitle: 'Track your streaks'),
            _HomeTabBody(title: 'Profile', subtitle: 'Account & settings'),
          ],
        ),
      ),
